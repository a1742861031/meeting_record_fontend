      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
        ...
        >
          ...
          <el-form-item prop="userType">
            <el-select v-model="form.userType" placeholder="请选择用户类型" class="userType">
              <el-option v-for="type in typeList" :key="type.typeId" :label="type.typeName" :value="type.typeId">
              </el-option>
              <vab-icon slot="prefix" :icon="['fas', 'layer-group']"></vab-icon>
            </el-select>

          </el-form-item>
          <el-form-item prop="userMobile">
            <el-input
              v-model.trim="form.userMobile"
              type="text"
              placeholder="请输入手机号"
              maxlength="11"
              show-word-limit
          ...
          <el-form-item prop="password">
            ...
            <el-form-item prop="password2">
              <el-input
                ...
                autocomplete="new-password"
              >
                <vab-icon slot="prefix" :icon="['fas', 'user-lock']"></vab-icon>
              </el-input>
            </el-form-item>
  ...
  methods: {
    ...
    handleReister() {
      this.$refs['registerForm'].validate(async (valid) => {
        if (valid) {
          this.userForm.userMobile = this.form.userMobile;
